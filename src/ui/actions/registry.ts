...
export const ACTIONS: readonly ActionDefinition[] = [
  ...
  {
    id: 'guidance.toggle',
    labelKey: 'action.guidance.toggle',
    descriptionKey: 'action.guidance.toggle.detail',
    icon: 'guide',
    shortcut: 'j',
    category: 'view',
  },
  ...
  },
  {
    ...
    labelKey: 'action.notifications.log',
    descriptionKey: 'action.notifications.log.detail',
    icon: 'log',
    shortcut: 'i',
    category: 'view',
  },
  {
    ...
    labelKey: 'action.notifications.settings',
    descriptionKey: null,
    icon: 'settings',
    shortcut: null,
    category: 'view',
  ...
  },
  {
    ...
    labelKey: 'action.notifications.dismiss',
    descriptionKey: null,
    icon: 'clear',
    shortcut: null,
    category: 'view',
